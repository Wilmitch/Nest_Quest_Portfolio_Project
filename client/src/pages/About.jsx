  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        ...
        your one-stop destination to find your dream home! We're passionate
        about connecting home seeekers with the perfect and ideal properties.
        With our user-friendly website that offers a wide variety of listings
        and a powerful search engine to ensure that your home quest journey is
        smooth and successful. So allow us to help you find your next perfect
        home.
      </p>
      <p className="mb-4 text-slate-700">
